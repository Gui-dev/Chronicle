...
describe('Photos Integration Tests', () => {
  ...
  describe('POST /api/memories/:id/photos', () => {
    it('should return 401 for unauthenticated request', async () => {
      const response = await server.inject({
        method: 'POST',
        url: '/api/memories/123e4567-e89b-12d3-a456-426614174000/photos',
        payload: {},
      })
  ...
  describe('DELETE /api/memories/:id/photos/:photoId', () => {
    it('should return 401 for unauthenticated request', async () => {
      const response = await server.inject({
        method: 'DELETE',
        url: '/api/memories/123e4567-e89b-12d3-a456-426614174000/photos/123e4567-e89b-12d3-a456-426614174000',
      })
